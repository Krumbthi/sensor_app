...
impl BMP280 {
    ...
    pub fn Process(&mut self) {   
        ...
        // Convert pressure and temperature data to 19-bits
        let adc_p: f32 = (((comp_data[0] as u32) << 12) + ((comp_data[1] as u32) << 4) + ((comp_data[2] as u32) >> 4)) as f32;
        let adc_t: f32 = (( (comp_data[3] as u32) << 12) + ((comp_data[4] as u32) << 4) + ((comp_data[5] as u32) >> 4)) as f32;
